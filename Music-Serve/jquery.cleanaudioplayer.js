...
(function($, undefined) {
	...
	jPlayerAudioPlaylist.prototype = {
		...
		_refresh: function(instant) {
			...
			if(instant && !$.isFunction(instant)) {
				...
				$.each(this.playlist, function(i) {
					$(self.cssSelector.playlist + " ul").append(self._createListItem(self.playlist[i], i));
				});
				this._updateControls();
			} else {
		...
		_createListItem: function(media, numb) {
			var self = this;
			...
			listItem += "<span href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'>" + (numb+1) + ". " + media.title + (media.artist ? " <span class='mdtc-clnplra-artist'>- " + media.artist + "</span>" : "") + "</span>";
			listItem += "</div></li>";
		...
		add: function(media, playNow) {
			$(this.cssSelector.playlist + " ul").append(this._createListItem(media, i)).find("li:last-child").hide().slideDown(this.options.playlistOptions.addTime);
			this._updateControls();
...
(function ($) {
    ...
    var playerTemplate = '<div class="mdtc-clnplra-audio mdtc-clnplra-main-player">' +
			...
			'<div class="mdtc-clnplra-gui mdtc-clnplra-interface media-player-fixed">' +
                ...
                '<div class="mdtc-clnplra-playlist" style="margin-top:5%;">' +
                    '<ul></ul>' +
                '</div>' +
